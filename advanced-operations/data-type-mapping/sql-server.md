# Data Type Mapping for SQL Server - HVR 6 | Fivetran Documentation

**Source:** https://fivetran.com/docs/hvr6/advanced-operations/data-type-mapping/data-type-mapping-for-sql-server

---


[Edit on GitHub](https://github.com/fivetran/engineering/blob/main/docs/hvr6/advanced-operations/data-type-mapping/data-type-mapping-for-sql-server/index.md)
...
When SQL Server is used as a source location, following is the mapping of data types in SQL Server to the corresponding Fivetran HVR repository data type.
 ...
 xml | Native | xml |
 hierarchyid **[1](#footnote)** | Native | hierarchyid |
...
> **Important:** 
Since 6.1.5/9, hierarchyid is supported as a native data type. As a result, it is no longer necessary to define actions for mapping hierarchyid as an [extended data type](https://fivetran.com/docs/hvr6/advanced-operations/extended-data-type-support#sqlserver); HVR can now directly map it without additional configuration.


## SQL Server as Target


When SQL Server is used as a target location, following is the mapping of HVR repository data types to the corresponding data type in SQL Server.
Text in green cell indicates the native data type of the DBMS
 Repository Data Type | Attributes | SQL Server (Windows-1252) |
 ansidate (ingres) | 
            nullable=0
         | date |
 ansidate | 
