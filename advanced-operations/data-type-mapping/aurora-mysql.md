# Data Type Mapping for Aurora MySQL - HVR 6 | Fivetran Documentation

**Source:** https://fivetran.com/docs/hvr6/advanced-operations/data-type-mapping/data-type-mapping-for-aurora-mysql

---


[Edit on GitHub](https://github.com/fivetran/engineering/blob/main/docs/hvr6/advanced-operations/data-type-mapping/data-type-mapping-for-aurora-mysql/index.md)
...
When Aurora MySQL is used as a source location, following is the mapping of data types in Aurora MySQL to the corresponding Fivetran HVR repository data type.
...
1 - Supported since HVR 6.2.5/2


## Aurora MySQL as Target


When Aurora MySQL is used as a target location, following is the mapping of HVR repository data types to the corresponding data type in Aurora MySQL.
Text in green cell indicates the native data type of the DBMS
 Repository Data Type | Attributes | Aurora MySQL (UTF-8) |
 ansidate (ingres) | 
            nullable=0
         | date |
 ansidate | 
